# KNMI climate data - bidirectional gated recurrent units(GRUs) with dropout
...
def windowed_dataset(series, window_size, batch_size, shuffle_buffer):
  # TFRecord-based architecture for data
...
# model architecture (bidirectional GRUs with dropout)
model = tf.keras.models.Sequential([
  # tf.keras.layers.Bidirectional: train the network to try to spot patterns from t to t+x as well as t+x to t
    # effectively train twice on each step (in original order + reverse order)
